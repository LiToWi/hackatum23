...
const MOOD_IMGS = ['/public/Piggy.png', '/public/Piggy.png', '/public/PiggyHappy.png'];
const SOLANA_IMG = '/public/Solana-Logo.png';
...
export function initCanvas(options: Options) {
    ...
    return {
        setMood, setLevel, feed, setDimensions: (width: number, height: number) => {
            stage.width(width);
            stage.height(height);
        }
    };
